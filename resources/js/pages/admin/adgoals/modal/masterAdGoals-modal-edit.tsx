...
export function EditMasterAdGoalsModal({ masterAdGoals, onSuccess }: EditMasterAdGoalsModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" size="icon" className="hover:bg-muted" title="Edit Ad Goal">
