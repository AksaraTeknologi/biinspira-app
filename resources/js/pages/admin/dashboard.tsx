      ...
      <div className="flex flex-col gap-6 p-4 md:p-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {statsCard.map(({ title, value, color, icon: Icon }) => (
            <Card key={title} className="shadow-sm border border-border/40">
          ...
          {/* Marketing */}
          <Card className="relative overflow-hidden shadow-sm border border-border/40">
            <CardHeader>
              <CardTitle className="text-sm font-semibold">Marketing</CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col justify-between h-full">
              <Button className="w-fit">Form Iklan</Button>
            </CardContent>
          </Card>
        </div>
