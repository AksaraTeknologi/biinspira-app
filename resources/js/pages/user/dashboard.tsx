...
import GraphCustom from '@/pages/user/card/graph';
import ReportCard from '@/pages/user/card/report';
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                ...
                <div className="grid grid-cols-5 gap-x-10 gapy-4">
                    <GraphCustom className="col-span-3" />
                    <ReportCard />
                </div>
            </div>
        </AppLayout >
