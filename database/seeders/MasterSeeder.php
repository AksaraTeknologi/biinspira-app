...
class MasterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        MasterPlatform::create(['id' => 4, 'name' => 'Media Partner',]);
        MasterPlatform::create(['id' => 5, 'name' => 'Google Ads',]);
        ...
        MasterAdGoal::create(['id' => 4, 'name' => 'SEM Klik Website',]);
        MasterAdGoal::create(['id' => 5, 'name' => 'GDN Klik Website',]);
